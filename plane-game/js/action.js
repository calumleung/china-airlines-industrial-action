...
function q2e() {
    document.getElementById("q2").style.display = "hidden";
...
function q3e() {
    document.getElementById("q3").style.display = "hidden";
...
function q4e() {
    document.getElementById("q4").style.display = "hidden";
...
function q5e() {
    document.getElementById("q5").style.display = "hidden";
