...
if(score==11000){
    document.getElementById("m1").style.display = "inline-table";
    document.getElementById("m2").style.display = "none";
}
else if(score>=10800){
    document.getElementById("m2").style.display = "inline-table";
    document.getElementById("m3").style.display = "none";
}
else if(score>=10600){
    document.getElementById("m3").style.display = "inline-table";
    document.getElementById("m4").style.display = "none";
}
else if(score>=10400){
    document.getElementById("m4").style.display = "inline-table";
    document.getElementById("m5").style.display = "none";
}
else if(score>=10200){
    document.getElementById("m5").style.display = "inline-table";
    document.getElementById("m6").style.display = "none";
}
else if(score>=10000){
    document.getElementById("m6").style.display = "inline-table";
}
else if(score>=8000){
    document.getElementById("m7").style.display = "inline-table";
    document.getElementById("m6").style.display = "none";
    document.getElementById("m5").style.display = "none";
  document.getElementById("m4").style.display = "none";
  document.getElementById("m3").style.display = "none";
  ...
  document.getElementById("m1").style.display = "none";
    ...
    document.getElementById("m8").style.display = "inline-table";
    document.getElementById("m7").style.display = "none";
}
else if(score>=4000){
    document.getElementById("m9").style.display = "inline-table";
    document.getElementById("m8").style.display = "none";
}
else if(score>=2000){
    document.getElementById("m10").style.display = "inline-table";
    document.getElementById("m9").style.display = "none";
}
else {
    document.getElementById("m11").style.display = "inline-table";
